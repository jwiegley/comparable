...
fn test_enum_5_variants() {
    ...
    assert_changes(
        ...
        Changed(MyEnumChange::BothScalarNamedField {
            some_int: I32Change(100, 200),
        }),
    );
    ...
    assert_changes(
        ...
        Changed(MyEnumChange::BothScalarUnnamedFields(
            Changed(I32Change(100, 200)),
            Unchanged,
        )),
    );
    assert_changes(
