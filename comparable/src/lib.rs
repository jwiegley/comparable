...
//!    a. Create the initial state or dataset you intend to test and make a copy of it
//!    b. Apply your operations and changes to this state.
//!    c. Use [`assert_changes!`] between the initial state and the resulting state to assert that whatever happened is exactly what you expected to happen.
//!
...
//!
//! ```
//! use comparable_derive::Comparable;
//! #[derive(Comparable)]
